...
if(isset($_POST['submit'])){
    ...
    $tag_id = filter_var($_POST['category_id'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if(!$title){
        ...
        $_SESSION['add-post'] = "Select post tag";
    }elseif(!$body){
        ...
        $thumbnail_destination_path="../assets/img/blog/" . $thumbnail_name;
    ...
    if(isset($_SESSION['add-post'])){
        ...
        $query="INSERT INTO posts (title, body, thumbnail, category_id, tag_id, author_id, is_featured) VALUES ('$title', '$body', '$thumbnail_name', $category_id ,$tag_id, $author_id, $is_featured)";
