...
if(isset($_POST['submit'])){
    ...
    if(!$title){
        ...
        if($thumbnail['name']){
            $previous_thumbnail_destination='../assets/img/blog/' . $previous_thumbnail_name;
    ...
    if(isset($_SESSION['edit-post'])){
        ...
        $thumbnail_to_insert= $thumbnail_name ?? $previous_thumbnail_name;
            ...
            $query="UPDATE posts SET title='$title', body='$body' ,thumbnail='$thumbnail_to_insert' ,category_id='$category_id', tag_id='$tag_id',is_featured=$is_featured WHERE id=$id LIMIT 1";
